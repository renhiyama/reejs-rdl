...
class HttpsClientRequest extends ClientRequest {constructor(...args2) { super(...args2); HttpsClientRequest.prototype.__init.call(this); }
   __init() {this.defaultProtocol = "https:"}
